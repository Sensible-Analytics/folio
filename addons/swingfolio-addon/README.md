...
A comprehensive Sensible Folio addon for tracking and analyzing swing trading
...
1. Download the addon package from the Sensible Folio addon marketplace
2. Install through the Sensible Folio addon manager
...
- All preferences and selections are stored securely using Sensible Folio's
  encrypted storage
- No data is transmitted outside of your Sensible Folio instance
...
- Visit the Sensible Folio community forums
- Submit issues through the addon feedback system
- Check the Sensible Folio documentation for addon troubleshooting
