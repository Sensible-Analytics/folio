...
A Sensible Folio addon that helps you visualize your investment progress towards
financial goals using an interactive calendar-style representation.

## Features

- **Goal Integration**: Seamlessly integrates with your existing Sensible Folio
...
1. **Select a Goal**: Choose from your existing Sensible Folio goals using the
...
3. Install in Sensible Folio through the addon settings page
...
- Integrate with the Sensible Folio sidebar navigation and routing system
...
MIT License - see the main Sensible Folio project for details.
