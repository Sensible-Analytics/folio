# Sensible Folio Addon Architecture

A straightforward explanation of how Sensible Folio's addon system works.

## What Are Sensible Folio Addons?

Addons are TypeScript modules that extend Sensible Folio's functionality. Each
...
│                                                                 │
│  ┌─────────────────┐              ┌─────────────────┐           │
│  │ Sensible Folio App │◀─ discover ─▶│ Dev Server      │           │
│  │                 │              │ localhost:3001  │           │
│  │ • Auto-discover │              │                 │           │
│  │ • Load addons   │              │ /health    ✓    │           │
│  │ • Hot reload    │              │ /status    ✓    │           │
