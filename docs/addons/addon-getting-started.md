...
- Node.js 20+ and pnpm
- Sensible Folio desktop app (optional but recommended: running in development
  mode for live reload and testing)
- Basic TypeScript and React knowledge
- Code editor (VS Code recommended)

## Start Sensible Folio (Recommended)

For the best development experience with live reload and testing, start Sensible
Folio in addon development mode:

```bash
# Clone Sensible Folio repository (if not already done)
...
cd ~/Documents/Sensible FolioAddons

# Create addon using CLI
npx @sensible-folio/addon-dev-tools create hello-world-addon
...
```json
{
  ...
  "version": "1.0.0",
  "description": "My first Sensible Folio addon",
  "author": "Your Name",
  "permissions": {
    "category": "ui",
...
function HelloWorldPage() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-4">Hello Sensible Folio</h1>
...
```
Sensible Folio Addon Development Server
...
- Auto-discovery by Sensible Folio
...
Verify in Sensible Folio:

1. Open Sensible Folio in addon development mode with
   `VITE_ENABLE_ADDON_DEV_MODE=true pnpm tauri dev`
...
import type { AddonContext, Account } from '@sensible-folio/addon-sdk';
...
function HelloWorldPage({ ctx }: { ctx: AddonContext }) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Hello Sensible Folio</h1>
          ...
          <div>
            ...
            {accounts.length > 0 ? (
              ...
              <p className="text-muted-foreground">
                No accounts found. Add an account in Sensible Folio to see data.
              </p>
            )}
          </div>
        )}
...
- CORS configured for Sensible Folio
...
- [Examples](https://github.com/Sensible-Analytics/folio/tree/main/addons/) -
