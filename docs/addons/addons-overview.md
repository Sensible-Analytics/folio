Sensible Folio addons are TypeScript modules that extend the application's
...
## What are Sensible Folio Addons?

Addons are TypeScript/React-based extensions that provide access to Sensible
Folio's financial data and UI system.
...
and components that integrate directly into Sensible Folio's interface.
...
```
┌─────────────────────────────────────────────────────────────────┐
│                    Sensible Folio Host Application                 │
├─────────────────────────────────────────────────────────────────┤
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐  │
...
npm install -D @sensible-folio/addon-dev-tools typescript vite
```

### Core Dependencies

- **@sensible-folio/addon-sdk**: TypeScript types and API definitions
- **@sensible-folio/ui**: UI components based on shadcn/ui and Tailwind CSS
- **@sensible-folio/addon-dev-tools**: CLI and development server
...
# Auto-discovered by Sensible Folio
```
...
Addons have access to Sensible Folio's UI component library:

```typescript
import { Button, Card, Dialog, Input, Table } from '@sensible-folio/ui';
import { AmountDisplay, GainAmount, CurrencyInput } from '@sensible-folio/ui/financial';
...
Sensible Folio Store, contact **support@sensible-folio.app**.
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
  ...
  <Card href="https://github.com/Sensible-Analytics/folio/tree/main/addons/">
