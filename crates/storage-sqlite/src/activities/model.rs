...
impl From<ActivityDetailsDB> for sensible_folio_core::activities::ActivityDetails {
    fn from(db: ActivityDetailsDB) -> Self {
        use sensible_folio_core::activities::ActivityStatus;
...
impl From<ImportMappingDB> for sensible_folio_core::activities::ImportMapping {
...
impl From<sensible_folio_core::activities::ImportMapping> for ImportMappingDB {
    fn from(domain: sensible_folio_core::activities::ImportMapping) -> Self {
        Self {
