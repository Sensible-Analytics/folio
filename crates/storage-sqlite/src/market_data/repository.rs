...
use sensible_folio_core::quotes::store::{ProviderSettingsStore, QuoteStore};
use sensible_folio_core::quotes::types::{AssetId, Day, QuoteSource};
use sensible_folio_core::quotes::{
...
impl QuoteStore for MarketDataRepository {
    ...
    fn get_latest_quote(&self, symbol: &str) -> Result<Quote> {
        ...
        match query_result {
            ...
            None => Err(sensible_folio_core::errors::Error::Database(
                sensible_folio_core::errors::DatabaseError::NotFound(format!(
