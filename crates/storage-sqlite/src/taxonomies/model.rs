...
impl From<TaxonomyDB> for sensible_folio_core::taxonomies::Taxonomy {
...
impl From<CategoryDB> for sensible_folio_core::taxonomies::Category {
...
impl From<AssetTaxonomyAssignmentDB> for sensible_folio_core::taxonomies::AssetTaxonomyAssignment {
...
impl From<sensible_folio_core::taxonomies::NewTaxonomy> for NewTaxonomyDB {
    fn from(domain: sensible_folio_core::taxonomies::NewTaxonomy) -> Self {
...
impl From<sensible_folio_core::taxonomies::NewCategory> for NewCategoryDB {
    fn from(domain: sensible_folio_core::taxonomies::NewCategory) -> Self {
        let now = chrono::Utc::now().to_rfc3339();
        Self {
            id: domain.id,
...
impl From<sensible_folio_core::taxonomies::NewAssetTaxonomyAssignment>
    for NewAssetTaxonomyAssignmentDB
{
    fn from(domain: sensible_folio_core::taxonomies::NewAssetTaxonomyAssignment) -> Self {
        let now = chrono::Utc::now().to_rfc3339();
        Self {
            id: domain.id,
