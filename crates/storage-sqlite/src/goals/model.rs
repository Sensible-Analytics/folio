...
impl From<GoalDB> for sensible_folio_core::goals::Goal {
...
impl From<GoalsAllocationDB> for sensible_folio_core::goals::GoalsAllocation {
...
impl From<sensible_folio_core::goals::NewGoal> for NewGoalDB {
    fn from(domain: sensible_folio_core::goals::NewGoal) -> Self {
        Self {
            id: domain.id,
            title: domain.title,
...
impl From<sensible_folio_core::goals::GoalsAllocation> for GoalsAllocationDB {
    fn from(domain: sensible_folio_core::goals::GoalsAllocation) -> Self {
        Self {
            id: domain.id,
