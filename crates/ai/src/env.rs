...
pub mod test_env {
    ...
    impl ActivityServiceTrait for MockActivityService {
        ...
        fn get_import_mapping(&self, _account_id: String) -> CoreResult<ImportMappingData> {
            ...
            Err(sensible_folio_core::errors::DatabaseError::NotFound(
        ...
        async fn import_activities(
            ...
            _account_id: String,
            _activities: Vec<ActivityImport>,
        ) -> CoreResult<sensible_folio_core::activities::ImportActivitiesResult> {
        ...
        fn parse_csv(
            &self,
            content: &[u8],
            config: &sensible_folio_core::activities::ParseConfig,
        ) -> CoreResult<sensible_folio_core::activities::ParsedCsvResult> {
            // Delegate to the actual core parser for testing
            sensible_folio_core::activities::parse_csv(content, config)
        }
        ...
        async fn prepare_activities(
            ...
            _account: &Account,
        ) -> CoreResult<sensible_folio_core::activities::PrepareActivitiesResult> {
            unimplemented!("MockActivityService::prepare_activities")
        }

        async fn upsert_activities_bulk(
            &self,
            _activities: Vec<sensible_folio_core::activities::ActivityUpsert>,
        ) -> CoreResult<sensible_folio_core::activities::BulkUpsertResult> {
    ...
    impl HoldingsServiceTrait for MockHoldingsService {
        ...
        async fn holdings_from_snapshot(
            &self,
            _snapshot: &sensible_folio_core::portfolio::snapshot::AccountStateSnapshot,
            _base_currency: &str,
        ) -> CoreResult<Vec<Holding>> {
            Ok(Vec::new())
        }
    ...
    impl PerformanceServiceTrait for MockPerformanceService {
        ...
        fn calculate_accounts_simple_performance(
            &self,
            _account_ids: &[String],
        ) -> CoreResult<Vec<sensible_folio_core::performance::SimplePerformanceMetrics>> {
            Ok(Vec::new())
        }
    }
