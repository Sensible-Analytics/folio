...
use sensible_folio_core::health::{MigrationResult, MigrationStatus};
use sensible_folio_core::taxonomies::{
...
async fn get_migration_status(
    ...
    let status = sensible_folio_core::health::get_migration_status(
...
async fn migrate_legacy_classifications(
    ...
    let result = sensible_folio_core::health::migrate_legacy_classifications(
        state.asset_service.as_ref(),
        state.taxonomy_service.as_ref(),
    )
    .await?;
